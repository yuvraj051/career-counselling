...
from .views import StudentListCreateView, StudentDetailView, UserProfileListCreateView
...
urlpatterns = [
    ...
    path('user/', UserProfileListCreateView.as_view()), # http://127.0.0.1:8000/api/user/
